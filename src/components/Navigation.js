...
const Navigation = () => (
  ...
  <NavLink to="/connect" className={({isActive}) => `nav-link-row text-rose-900 block text-center px-3 py-1 text-sm hover:bg-rose-500 hover:text-white transition-colors duration-200 border-b-2 border-rose-900 ${isActive ? 'active' : ''}`}><span className="nav-link-text">Connect With Me!</span></NavLink>
  ...
  <NavLink to="/oc-gallery" className={({isActive}) => `nav-link-row text-rose-900 block text-center px-3 py-1 text-sm hover:bg-rose-500 hover:text-white transition-colors duration-200 border-b-2 border-rose-900 ${isActive ? 'active' : ''}`}><span className="nav-link-text">OC Gallery</span></NavLink>
  <NavLink to="/guestbook" className={({isActive}) => `nav-link-row text-rose-900 block text-center px-3 py-1 text-sm hover:bg-rose-500 hover:text-white transition-colors duration-200 border-b-2 border-rose-900 ${isActive ? 'active' : ''}`}><span className="nav-link-text">Guestbook</span></NavLink>
    </nav>
  </div>
);
